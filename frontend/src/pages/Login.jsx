...
const Login = () => (
  <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white">
    ...
    <div className="flex flex-col gap-4">
      <a href={`${BACKEND_URL}/login/google`} className="flex gap-2 items-center bg-gray-800 px-4 py-2 rounded-md hover:bg-gray-700">
        <img src="/google-logo.png" alt="Google" className="h-6 w-6" /> Sign in with Google
      </a>
      <a href={`${BACKEND_URL}/login/github`} className="flex gap-2 items-center bg-gray-800 px-4 py-2 rounded-md hover:bg-gray-700">
